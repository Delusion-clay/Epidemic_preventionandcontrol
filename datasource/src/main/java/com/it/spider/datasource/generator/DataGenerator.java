package com.it.spider.datasource.generator;

import com.alibaba.fastjson.JSON;
import com.it.spider.datasource.bean.MateriaBean;
...
public class DataGenerator {
    ...
    public void generator() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            kafkaTemplate.send("ooo", ran.nextInt(3),jsonStr);
        }
    }
